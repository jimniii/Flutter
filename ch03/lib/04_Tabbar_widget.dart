...
class BottomTabBarTest extends StatefulWidget{
  ...
  @override
  State<BottomTabBarTest> createState() => _BottomeTabBarTestState();
}

class _BottomeTabBarTestState extends State<BottomTabBarTest> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('04.Bottome TabBar 실습'),
        ),
